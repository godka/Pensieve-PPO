...
RANDOM_SEED = 42
RAND_RANGE = 1000
SUMMARY_DIR = './results_MVT'
LOG_FILE = './results_MVT/log'
TEST_LOG_FOLDER = './test_results_MVT/'
TRAIN_TRACES = './train/'
# NN_MODEL = './results/pretrain_linear_reward.ckpt'
NN_MODEL = None #'pretrain/nn_model_ep_151200.ckpt'
handover = 'MVT'
...
def testing(epoch, nn_model, log_file):
    ...
    # run test script
    os.system('python rl_no_training.py --NN_MODEL=' + nn_model + ' --handover=' + handover + ' --LOG=' + TEST_LOG_FOLDER)
