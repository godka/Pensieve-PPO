...
parser.add_argument('--TRAIN_EPOCH', type=int, default=50000)
...
def testing(epoch, nn_model, log_file):
    ...
    # run test script
    cmd = 'python test2.py ' + '--NN_MODEL=' + nn_model + ' --NUM_AGENTS=' + str(USERS) + ' --trace=' + args.trace
    print(cmd)
    os.system(cmd)
