...
parser.add_argument('--NN_MODEL', type=str, default='./models/pretrain_linear_reward.ckpt')
parser.add_argument('--NUM_AGENTS', type=int, default=1)
parser.add_argument('--trace', type=str, default="starlink")
parser.add_argument('--LOG', type=str, default='./test_results/')
args = parser.parse_args()

NN_MODEL = args.NN_MODEL
NUM_AGENTS = args.NUM_AGENTS
LOG_FILE=args.LOG + 'log_sim_bb'
...
SCALE_FOR_TEST /= args.NUM_AGENTS
...
def main():
    ...
    with tf.Session() as sess:
        ...
        while True:  # serve video forever
            ...
            Qua_batch.append(VIDEO_BIT_RATE[bit_rate] / M_IN_K)
            Rebuf_batch.append(REBUF_PENALTY * rebuf)
            Smooth_batch.append(SMOOTH_PENALTY * np.abs(VIDEO_BIT_RATE[bit_rate] -
                                            VIDEO_BIT_RATE[last_bit_rate]) / M_IN_K)
            ...
            if end_of_video:
                ...
                data = sum(r_batch[1:]) / len(r_batch[1:]) 
