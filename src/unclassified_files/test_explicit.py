...
from env.multi_bw_share import load_trace, fixed_env_explicit as env
from models.references import ppo as network
...
LOG_FILE = './test_results_exp' + str(NUM_AGENTS) + '/log_sim_ppo'
# A_SAT = NUM_AGENTS
