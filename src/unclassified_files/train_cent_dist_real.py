...
import structlog
from util.constants import A_DIM, PAST_SAT_LOG_LEN, TRAIN_REAL_TRACES
import logging
...
RANDOM_SEED = 42
SUMMARY_DIR = './ppo_imp_agg_weight_v2_real'
MODEL_DIR = '..'

TEST_LOG_FOLDER = './test_results_imp_agg_weight_v2_real'
PPO_TRAINING_EPO = 5
...
def testing(epoch, nn_model, log_file):
    ...
    # run test script
    log.info('python test_cent_dist_real.py ', nn_model=nn_model + ' ' + str(USERS))
    os.system('python test_cent_dist_real.py ' + nn_model + ' ' + str(USERS))
