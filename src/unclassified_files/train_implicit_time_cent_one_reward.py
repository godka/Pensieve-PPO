...
from util.constants import A_DIM, MAX_SAT, PAST_SAT_LOG_LEN, TRAIN_TRACES
...
RANDOM_SEED = 42
SUMMARY_DIR = './ppo_imp_cent_one_reward'
MODEL_DIR = '..'
TEST_LOG_FOLDER = './test_results_imp_cent_one_reward'
PPO_TRAINING_EPO = 5
...
def testing(epoch, nn_model, log_file):
    ...
    # run test script
    log.info('python test_implicit_time_cent_one_reward.py ', nn_model=nn_model + ' ' + str(USERS))
    os.system('python test_implicit_time_cent_one_reward.py ' + nn_model + ' ' + str(USERS))
