...
from env.multi_bw_share.env_cent_v2_noaa import ABREnv
...
def testing(epoch, nn_model, log_file):
    ...
    # run test script
    log.info('python test_cent_cent_v2_noaa.py ', nn_model=nn_model + ' ' + str(USERS))
    os.system('python test_cent_cent_v2_noaa.py ' + nn_model + ' ' + str(USERS))
