...
from models.rl_multi_bw_share.ppo_spec import ppo_cent3 as network

S_INFO = 10 + 1 + 3 + 2 * 5  # Original + nums of sat + bw of sats + decisions of users
PAST_SAT_LOG_LEN = 1
    ...
    with tf.Session() as sess:
        ...
        while True:  # serve video forever
            ...
            other_user_sat_decisions, other_sat_num_users, other_sat_bws \
                = encode_other_sat_info(net_env, cur_sat_id, next_sat_id, agent, other_sat_users,
