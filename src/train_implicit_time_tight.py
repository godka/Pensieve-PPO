...
import numpy as np
import os
from env.multi_bw_share.env_tight_time import ABREnv
...
RANDOM_SEED = 42
SUMMARY_DIR = './ppo_imp_tight'
MODEL_DIR = '..'
TRAIN_TRACES = 'data/sat_data/train/'
TEST_LOG_FOLDER = './test_results_imp_tight'
PPO_TRAINING_EPO = 5
...
def testing(epoch, nn_model, log_file):
    ...
    # run test script
    log.info('python test_implicit_time_tight.py ', nn_model=nn_model + ' ' + str(USERS))
    os.system('python test_implicit_time_tight.py ' + nn_model + ' ' + str(USERS))
