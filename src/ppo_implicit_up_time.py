...
class Network():
    def CreateNetwork(self, inputs):
        with tf.variable_scope('actor'):
            ...
            split_9 = tflearn.fully_connected(inputs[:, 9:10, -1], FEATURE_NUM, activation='relu')
            split_10 = tflearn.fully_connected(inputs[:, 10:11, -1], FEATURE_NUM, activation='relu')
            ...
            merge_net = tflearn.merge(
                [split_0, split_1, split_2_flat, split_3_flat, split_4_flat, split_5, split_6_flat, split_7_flat, split_8_flat, split_9, split_10], 'concat')
