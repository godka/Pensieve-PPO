...
VIDEO_BIT_RATE = [200, 300, 450, 750, 1200,
...
def main():
    ...
    with tf.Session() as sess:
        ...
        action = bitrate_to_action(
            bit_rate, net_env.video_masks[net_env.video_idx])
        last_action = action
        ...
        while True:  # serve video forever
            ...
            if end_of_video:
                ...
                log_path = LOG_FILE + '_' + \
                    net_env.all_file_names[net_env.trace_idx]
                log_file = open(log_path, 'w')
