...
RANDOM_SEED = 42
SUMMARY_DIR = './ppo_cent_test'
MODEL_DIR = './models'
TRAIN_TRACES = './train/'
TEST_LOG_FOLDER = './test_results_cent_his_test'
PPO_TRAINING_EPO = 5
...
def testing(epoch, nn_model, log_file):
    ...
    # run test script
    print('python test_cent_his3.py ' + nn_model + ' ' + str(USERS))
    os.system('python test_cent_his3.py ' + nn_model + ' ' + str(USERS))
