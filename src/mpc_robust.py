...
RANDOM_SEED = 42
RAND_RANGE = 1000000
LOG_FOLDER = 'sim/mpc_results/'
LOG_FILE = LOG_FOLDER + 'log_sim_mpc_robust_qoe'
...
def main():
    ...
    all_cooked_bw, all_cooked_time, all_file_names = load_trace.load_trace(split_condition="test")
    ...
    log_file.write("{: <15} {: <10} {: <10} {: <15} {: <15} {: <15} {: <15}"
                   ...
                   .format("time_stamp", "is_handover", "cur_sat_id", "download_bw", "pred_download_bw",
                           ...
                           "chunk_size", "delay_time", "reward", "pred_bw", "vis_sat_nums", "num_of_users"))
    ...
    while True:  # serve video forever
        ...
        end_of_video_or_network, video_chunk_remain, cur_sat_id, avg_throughput, is_handover, vis_sat_nums, \
        num_of_users = \
        ...
        log_file.write("{: <15} {: <10} {: <10} {: <15} {: <15} {: <15} {: <15}"
                       ...
                       .format(str(round(time_stamp, 3)), str(is_handover), str(cur_sat_id),
                               ...
                               str(pred_bw), str(vis_sat_nums), str(num_of_users)))
