...
import structlog
from util.constants import A_DIM, TRAIN_TRACES, PAST_SAT_LOG_LEN, TRAIN_TRACES
import logging
...
RANDOM_SEED = 42
SUMMARY_DIR = './ppo_imp_agg_weight_v2_v2'
MODEL_DIR = '..'

TEST_LOG_FOLDER = './test_results_imp_agg_weight_v2_v2'
PPO_TRAINING_EPO = 5
...
def testing(epoch, nn_model, log_file):
    ...
    # run test script
    log.info('python test_cent_dist_v2.py ', nn_model=nn_model + ' ' + str(USERS))
    os.system('python test_cent_dist_v2.py ' + nn_model + ' ' + str(USERS))
