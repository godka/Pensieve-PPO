...
from models.rl_multi_bw_share.ppo_spec import ppo_cent2 as network
...
RANDOM_SEED = 42
SUMMARY_DIR = './ppo_cent2'
MODEL_DIR = '..'
TRAIN_TRACES = '../../data/sat_data/train/'
TEST_LOG_FOLDER = './test_results_cent2'
PPO_TRAINING_EPO = 5
...
def testing(epoch, nn_model, log_file):
    ...
    # run test script
    print('python test_cent_v2.py ' + nn_model + ' ' + str(USERS))
    os.system('python test_cent_v2.py ' + nn_model + ' ' + str(USERS))
