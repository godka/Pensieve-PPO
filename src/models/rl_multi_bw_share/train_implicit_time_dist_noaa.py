...
from env.multi_bw_share.env_time_noaa_dist import ABREnv
...
RANDOM_SEED = 42
SUMMARY_DIR = './ppo_imp_dist_noaa'
MODEL_DIR = '..'
TEST_LOG_FOLDER = './test_results_imp_dist_noaa'
PPO_TRAINING_EPO = 5
...
def testing(epoch, nn_model, log_file):
    ...
    # run test script
    log.info('python test_implicit_time_dist_noaa.py ', nn_model=nn_model + ' ' + str(USERS))
    os.system('python test_implicit_time_dist_noaa.py ' + nn_model + ' ' + str(USERS))
