...
from env.multi_bw_share.env_cent_time_agg import ABREnv
...
def testing(epoch, nn_model, log_file):
    ...
    # run test script
    log.info('python test_implicit_time_agg_cent_weight_cent.py ', nn_model=nn_model + ' ' + str(USERS))
    os.system('python test_implicit_time_agg_cent_weight_cent.py ' + nn_model + ' ' + str(USERS))
