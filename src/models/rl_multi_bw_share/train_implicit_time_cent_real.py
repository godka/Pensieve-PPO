...
from env.multi_bw_share.env_cent_real_time import ABREnv
...
RANDOM_SEED = 42
SUMMARY_DIR = './ppo_imp_cent_real'
MODEL_DIR = '..'
TEST_LOG_FOLDER = './test_results_imp_cent_real'
PPO_TRAINING_EPO = 5
...
def testing(epoch, nn_model, log_file):
    ...
    # run test script
    log.info('python test_implicit_time_cent_real.py ', nn_model=nn_model + ' ' + str(USERS))
    os.system('python test_implicit_time_cent_real.py ' + nn_model + ' ' + str(USERS))
