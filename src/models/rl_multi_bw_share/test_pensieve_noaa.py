...
from util.constants import CHUNK_TIL_VIDEO_END_CAP, BUFFER_NORM_FACTOR, VIDEO_BIT_RATE, REBUF_PENALTY, SMOOTH_PENALTY, \
    DEFAULT_QUALITY, BITRATE_WEIGHT, M_IN_K, A_DIM, PAST_LEN, PAST_LEN, BITRATE_REWARD, TEST_NOAA_TRACES
...
SUMMARY_DIR = './test_results_pensieve_noaa' + str(USERS)
if not os.path.exists(SUMMARY_DIR):
    os.makedirs(SUMMARY_DIR)
LOG_FILE = SUMMARY_DIR + '/log_sim_pensieve_noaa'
...
def main():
    ...
    with tf.Session() as sess:
        ...
        actor = network.Network(sess,
                                state_dim=[S_INFO, PAST_LEN], action_dim=A_DIM,
        ...
        while True:  # serve video forever
            ...
            cur_sat_user_num, next_sat_user_num, cur_sat_bw_logs, connected_time, cur_sat_id, next_sat_id, _, _, _, _, _, _, _ = \
