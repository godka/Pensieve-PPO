    ...
    def CreateNetwork(self, inputs):
        with tf.variable_scope('actor'):
            ...
            for i in range(self.num_agents - 1):
                ...
                split_2 = tflearn.fully_connected(inputs[:, 11 + 8 * i:12 + 8 * i, -1], int(FEATURE_NUM/2), activation='relu')
                split_3 = tflearn.fully_connected(inputs[:, 12 + 8 * i:13 + 8 * i, -1], int(FEATURE_NUM/2), activation='relu')
                split_4 = tflearn.fully_connected(inputs[:, 13 + 8 * i:14 + 8 * i, -1], int(FEATURE_NUM/2), activation='relu')
                split_5 = tflearn.fully_connected(inputs[:, 14 + 8 * i:15 + 8 * i, -1], int(FEATURE_NUM/2), activation='relu')
                split_6 = tflearn.fully_connected(inputs[:, 15 + 8 * i:16 + 8 * i, -1], int(FEATURE_NUM/2), activation='relu')
                split_7 = tflearn.fully_connected(inputs[:, 16 + 8 * i:17 + 8 * i, -1], int(FEATURE_NUM/2), activation='relu')
            ...
            # value_net = tflearn.fully_connected(merge_net, int(FEATURE_NUM/2), activation='relu')
            ...
            # value_net3 = tflearn.fully_connected(value_net2, int(FEATURE_NUM/4), activation='relu')
            pi = tflearn.fully_connected(value_net, self.a_dim, activation='softmax')
