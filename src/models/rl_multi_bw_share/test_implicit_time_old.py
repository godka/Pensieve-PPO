...
from models.rl_multi_bw_share.ppo_spec import ppo_implicit_old as network
import structlog
import logging

S_INFO = 6 + 3 + 2  # bit_rate, buffer_size, next_chunk_size, bandwidth_measurement(throughput and time), chunk_til_video_end
A_SAT = 2
ACTOR_LR_RATE = 1e-4
