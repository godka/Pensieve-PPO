...
from env.multi_bw_share.env_cent_v1_real import ABREnv
from models.rl_multi_bw_share.ppo_spec import ppo_cent_dist_v2 as network
import tensorflow.compat.v1 as tf
import structlog
from util.constants import A_DIM, NUM_AGENTS, TRAIN_TRACES, PAST_SAT_LOG_LEN, TRAIN_REAL_TRACES
import logging
...
RANDOM_SEED = 42
SUMMARY_DIR = './ppo_imp_agg_weight_v2_real_v2'
MODEL_DIR = '..'

TEST_LOG_FOLDER = './test_results_imp_agg_weight_v2_real_v2'
PPO_TRAINING_EPO = 5
...
def testing(epoch, nn_model, log_file):
    ...
    # run test script
    log.info('python test_cent_dist_v2_real.py ', nn_model=nn_model + ' ' + str(USERS))
    os.system('python test_cent_dist_v2_real.py ' + nn_model + ' ' + str(USERS))
