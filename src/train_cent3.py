...
import os
import sys
from muleo_lc_bw_share.env_cent3 import ABREnv
...
RANDOM_SEED = 42
SUMMARY_DIR = './ppo_cent3'
MODEL_DIR = './models'
TRAIN_TRACES = './train/'
TEST_LOG_FOLDER = './test_results_cent3'
PPO_TRAINING_EPO = 5
...
def testing(epoch, nn_model, log_file):
    ...
    # run test script
    print('python test_cent3.py ' + nn_model + ' ' + str(USERS))
    os.system('python test_cent3.py ' + nn_model + ' ' + str(USERS))
