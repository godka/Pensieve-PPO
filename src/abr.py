...
class ABREnv():
    ...
    def reset(self):
        ...
        self.mu = np.random.uniform() * 10.
        self.sigma = np.random.uniform() * 10.
        ...
        state[6, :2] = np.array([self.mu, self.sigma]) / 10.
    ...
    def step(self, action):
        ...
        reward = VIDEO_BIT_RATE[bit_rate] / M_IN_K \
            - self.mu * rebuf \
            - self.sigma * np.abs(VIDEO_BIT_RATE[bit_rate] -
